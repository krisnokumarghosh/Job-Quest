...
function FeatureCard({ feature }) {
  return (
    <motion.div
      ...
      className="group flex items-start gap-4 border hover:border-[#F7C2FF] rounded-2xl p-5 cursor-default"
      style={{ transition: "border-color 0.3s" }}
    >
      <div className="shrink-0 w-10 h-10 rounded-xl bg-linear-to-t from-[#313131] to-[#010102] flex items-center justify-center">
        <span className="text-[#F7C2FF] flex">{feature.icon}</span>
      </div>
      <div>
  ...
  return (
    <section className="bg-[#151516] py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.h2
          className="text-white text-4xl md:text-5xl font-bold text-center leading-tight mb-16"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeUp}
